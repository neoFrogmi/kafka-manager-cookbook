...
property :download_url, String, default: 'https://packagecloud.io/spuder/kafka-manager/packages/ubuntu/#{node['lsb']['codename']}/kafka-manager_#{package_version}_all.deb/download.deb'
