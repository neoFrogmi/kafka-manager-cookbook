...
default['kafka-manager']['download_url'] = "https://packagecloud.io/spuder/kafka-manager/packages/ubuntu/#{node['lsb']['codename']}/kafka-manager_1.2.7_all.deb/download.deb"
